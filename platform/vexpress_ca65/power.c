 ...
 * FVP VEXPRESS MultiThreading - Secondary CPUs PowerUp/PowerDown
 * Cortex-A65 / Cortex-A65AE / Neoverse-E1 SMT
 */
...
static int ca65_cpu_up(unsigned int cpu)
{
...
static const struct cpu_pm_ops ca65_pm_ops = {
	.cpu_up = ca65_cpu_up,
	.cpu_die = ca65_cpu_die
};
