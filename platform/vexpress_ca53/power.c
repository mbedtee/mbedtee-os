 ...
 * FVP VEXPRESS CA53x4 Secondary CPUs PowerUp/PowerDown
 */
...
static int ca53_cpu_up(unsigned int cpu)
{
...
static const struct cpu_pm_ops ca53_pm_ops = {
	.cpu_up = ca53_cpu_up,
	.cpu_die = ca53_cpu_die
};
