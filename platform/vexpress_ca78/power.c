 ...
 * FVP VEXPRESS CA78x4 Secondary CPUs PowerUp/PowerDown
 */
...
static int ca78_cpu_up(unsigned int cpu)
{
...
static const struct cpu_pm_ops ca78_pm_ops = {
	.cpu_up = ca78_cpu_up,
	.cpu_die = ca78_cpu_die
};
