 ...
 * FVP VEXPRESS CA5x4 Secondary CPUs PowerUp/PowerDown
 */
...
static int ca5_cpu_up(unsigned int cpu)
{
...
static const struct cpu_pm_ops ca5_pm_ops = {
	.cpu_up = ca5_cpu_up,
	.cpu_die = ca5_cpu_die
};
