 ...
 * FVP VEXPRESS CA15x4 Secondary CPUs PowerUp/PowerDown
 */
...
static int ca15_cpu_up(unsigned int cpu)
{
...
static const struct cpu_pm_ops ca15_pm_ops = {
	.cpu_up = ca15_cpu_up,
	.cpu_die = ca15_cpu_die
};
