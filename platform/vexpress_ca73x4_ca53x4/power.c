 ...
 * FVP VEXPRESS CA73x4_CA53x4 Secondary CPUs PowerUp/PowerDown
 */
...
static int ca73_ca53_cpu_up(unsigned int cpu)
{
 ...
 */
static void ca73_ca53_cpu_die(void)
{
...
static const struct cpu_pm_ops ca73_ca53_pm_ops = {
	.cpu_up = ca73_ca53_cpu_up,
	.cpu_die = ca73_ca53_cpu_die
};
...
static int __init cpu_power_probe(struct device *dev)
{
	...
	cpu_pm_register(&ca73_ca53_pm_ops);
